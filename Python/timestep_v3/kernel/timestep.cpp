...
void torch_Qinit(Qsolver &Qsol, param p, int BSZ, torch::Tensor &w, torch::Tensor &r1, torch::Tensor &r2, torch::Tensor &ra){
    Qsol.init(p, BSZ, w, r1, r2,ra);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    .def("initflag",&Qsolver::initstate)
    ;
}
