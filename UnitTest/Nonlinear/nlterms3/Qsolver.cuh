...
void wlin_func(Qreal *IFw, Qreal *IFwh, Qreal *k_squared, Qreal Re, Qreal Rf, Qreal dt, int Nxh, int Ny, int BSZ){
    ...
    if (i<Nxh && j<Ny){
        int index = i + j*Nxh;
        IFw[index] = 1.0/Re * (-1.0*k_squared[index] - Rf)*dt;
        IFwh[index] = 1.0/Re * (-1.0*k_squared[index] - Rf)*dt/2.0;
    }
}
...
void r1lin_func(Qreal *IFr1, Qreal *IFr1h, Qreal *k_squared, Qreal Re, Qreal Rf, Qreal dt, int Nxh, int Ny, int BSZ){
    ...
    if (i<Nxh && j<Ny){
        int index = i + j*Nxh;
        IFr1[index] = (-1.0*k_squared[index] + 1.0)*dt;
        IFr1h[index] = (-1.0*k_squared[index] + 1.0)*dt/2.0;
    }
}
...
void r2lin_func(Qreal *IFr2, Qreal *IFr2h, Qreal *k_squared, Qreal dt, int Nxh, int Ny, int BSZ){
    ...
    if (i<Nxh && j<Ny){
        int index = i + j*Nxh;
        IFr2[index] = (-1.0*k_squared[index] + 1.0)*dt;
        IFr2h[index] = (-1.0*k_squared[index] + 1.0)*dt/2.0;
    }
}
